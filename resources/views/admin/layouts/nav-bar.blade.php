<div class="header">
    <div class="header-left">
        <a href="index.html" class="logo"> <img src="admin/assets/img/hotel_logo.png" width="50" height="70" alt="logo"> <span class="logoclass">KING HOTEL</span> </a>
        <a href="index.html" class="logo logo-small"> <img src="admin/assets/img/hotel_logo.png" alt="Logo" width="30" height="30"> </a>
    </div>
